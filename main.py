...
K_dict = {"多云": 0.9, "阴": 0.9, "小雨": 0.9, "中雨": 0.9, "大雨": 0.9, "暴雨": 0.9, "大暴雨": 0.9, "特大暴雨": 0.9}
...
min_dict = {time_list[0]: 11100, time_list[1]: 11500, time_list[2]: 12000, time_list[3]: 13000, time_list[4]: 14000, time_list[5]: 15000, time_list[6]: 16000}
# 最大步数（例如现在设置意思是在8点（你设置的第一个时间点默认8）运行会在1500到2999中随机生成一个数提交（开启气候降低步数会乘系数K）10点3000~4999。。。以此类推，步数范围建议看懂了再改，没看懂直接默认就好）
max_dict = {time_list[0]: 11200, time_list[1]: 12000, time_list[2]: 12999, time_list[3]: 13999, time_list[4]: 14999, time_list[5]: 15999, time_list[6]: 17000}
# 设置结束
